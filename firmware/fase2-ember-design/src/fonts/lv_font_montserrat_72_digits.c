 ...
 * Size: 72 px
 * Bpp: 4
 * Opts: --no-compress --bpp 4 --size 72 --font .pio/libdeps/esp32dev/lvgl/scripts/built_in_font/Montserrat-Medium.ttf --symbols=-0123456789: --format lvgl -o src/fonts/lv_font_montserrat_72_digits.c --lv-font-name lv_font_montserrat_72_digits --force-fast-kern-format
 ******************************************************************************/
...
#ifndef LV_FONT_MONTSERRAT_72_DIGITS
#define LV_FONT_MONTSERRAT_72_DIGITS 1
#endif

#if LV_FONT_MONTSERRAT_72_DIGITS
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 10006, .adv_w = 262, .box_w = 10, .box_h = 39, .ofs_x = 3, .ofs_y = 0}
};
...
#else
lv_font_t lv_font_montserrat_72_digits = {
#endif
...
#endif /*#if LV_FONT_MONTSERRAT_72_DIGITS*/
